...
const UpdateCoffee = () => {
    const updateCoffeeLoader = useLoaderData()
    const [updateCoffee, setUpdateCoffee] = useState(updateCoffeeLoader)
    // console.log(updateCoffee._id)
    ...
    return (
        <div>
            <div className="max-w-2xl mx-auto mt-10 p-6 my-10 bg-gray-100 rounded shadow">
                <h2 className="text-center text-2xl font-semibold mb-4">Update Existing Coffee</h2>
